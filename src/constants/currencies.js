...
export const DEFAULT_PORTFOLIO = [
  // ── USD (base currency) ───────────────────────────────────────────────────
  {
    ...
    monthlyActualVolumes: Array(12).fill(2500000),
  ...
  // ── AUD  (budget: 0.60 USD/AUD) ───────────────────────────────────────────
  {
    ...
    monthlyActualVolumes: Array(12).fill(2777777.778),
    isCollapsed: true, rateDirection: 'USD_PER_LOCAL',
    rateSource: 'CSV', monthlyRateSources: Array(12).fill('CSV'),
  },
  ...
  // ── GBP  (budget: 1.30 USD/GBP) ───────────────────────────────────────────
  {
    ...
    monthlyActualVolumes: Array(12).fill(961538.4615),
    isCollapsed: true, rateDirection: 'USD_PER_LOCAL',
    rateSource: 'CSV', monthlyRateSources: Array(12).fill('CSV'),
  },
  ...
  // ── SGD  (budget: 0.75 USD/SGD) ───────────────────────────────────────────
  {
    ...
    monthlyActualVolumes: Array(12).fill(1111111.111),
    isCollapsed: true, rateDirection: 'USD_PER_LOCAL',
    rateSource: 'CSV', monthlyRateSources: Array(12).fill('CSV'),
  },
];
